...
public class ExtentReportListener {
	...
	public static  ExtentReports setUp() {
		String reportLocation = "C:\\Users\\Admin\\eclipse-workspace\\Test_BDD2\\test output\\spark\\reports.html";
	...
	public static String captureScreenShot(WebDriver driver) throws IOException {
		...
		String dest = "D://" + getcurrentdateandtime() + ".png";
		File target = new File(dest);
		FileUtils.copyFile(screenshotsource, target);
		return dest;
	}
